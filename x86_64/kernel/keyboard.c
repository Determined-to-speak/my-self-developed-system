//
// Created by lizhijiangjiang/Determined-to-speak on 24-1-31.
//
...
#include "../include/x86_64/linux/types.h"
...
static char keymap[][4] = {
        ...
        /* 0x5F */
                   {INV, INV,   false, false}, // PrintScreen
};
...
void keymap_handler(int idt_index) {
    ...
    uchar scancode = my_in_byte(0x60);
